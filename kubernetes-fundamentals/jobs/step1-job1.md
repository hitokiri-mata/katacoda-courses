...
A simple way to create a Job is with the Kubectl command. This command runs the Job in the form of a Pod that contains a single container. The app in the container simply generates security keys.
